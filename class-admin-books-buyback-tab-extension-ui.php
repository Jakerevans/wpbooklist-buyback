...
if ( ! class_exists( 'Admin_Books_Buyback_Tab_Extension_Ui', false ) ) :
    /**
    * Admin_Books_Buyback_Tab_Extension_Ui.
    */
class Admin_Books_Buyback_Tab_Extension_Ui {
    ...
    public function __construct() {
        ...
        require_once(BUYBACK_CLASS_DIR.'class-buyback-form.php');
    ...
    private function output_open_admin_container(){
        ...
        $title = 'BuyBack';
        $icon_url = BUYBACK_ROOT_IMG_ICONS_URL.'search.svg';
