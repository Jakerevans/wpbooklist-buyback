...
jQuery(document).ready(function($) {
	...
	function wpbooklist_buyback_jre_find_book(){
		...
		$("#wpbooklist-buyback-search-button, #wpbooklist-buyback-search-button-nonmembers").click(function(event){
			...
			var nonmembershortcode = 'false';
			if ( 'wpbooklist-buyback-search-button-nonmembers' === $(this).attr( 'id' ) ) {
				nonmembershortcode = 'true';
			}
			var username = '';
			...
			var data = {
				...
				'isbn':isbn,
				'username':username,
				'nonmembershortcode': nonmembershortcode
			};
			console.log(data)
	...
	function wpbooklist_buyback_jre_handle_search_results(results, phase){
		...
		var nonmembershortcode = results[5];
...
+'image_unavaliable.png';
	    		...
	    		if ( "Sorry, we're unable to purchase this title!" === finalPrice ) {
	    			html = html+'<div class="wpbooklist-buyback-indiv-holder"><div data-priceformatted="'+lowestUsedFormatted+'" data-unformatted="'+lowestUsedUnformatted+'" data-rank="'+itemRank+'" data-similar="'+similarproductsstring+'" data-details="'+details+'" data-isbn="'+isbn+'" data-title="'+title+'" data-author="'+author+'" data-category="'+category+'" data-pages="'+pages+'" data-publisher="'+publisher+'" data-pubdate="'+pubdate+'" data-description="'+description+'" data-isbn="'+isbn+'" data-review="'+review+'" data-similar="'+similar+'"   class="wpbooklist-buyback-results-indiv"><img class="wpbooklist-buyback-colorbox" src="'+image+'" /><div id="wpbooklist_saved_title_and_select_div"><p class="wpbooklist_saved_title_link" id="wpbooklist_saved_title_link">'+title+'</p><div style="'+inlinePriceStyle+'" class="wpbooklist-buyback-quote-div"><span class="wpbooklist-buyback-quote-label"></span><span class="wpbooklist-buyback-quote-actual"><img style="height:initial;width:100px;position:relative;top:0px;left:35px;" src="'+wpbooklist_buyback_php_variables.wpbooklistbuybackrootimgiconsurl+'red-x.png"/></span></div><div class="wpbooklist-buyback-checkbox-div"><button style="display:none;opacity:'+buttonOpacity+';" '+disabledButton+' id="wpbooklist-buyback-select-title-button-id-'+0+'" data-triggered="false" data-bookimgsrc="'+image+'" data-bookisbn="'+isbn+'" data-bookvalue="'+finalPriceWithoutSym+'" data-booktitle="'+title+'" data-buttonid="'+0+'" class="wpbooklist-buyback-select-title-button">Sell This Book</button></div></div></div></div>';
	    		} else {
	    			html = html+'<div class="wpbooklist-buyback-indiv-holder"><div data-priceformatted="'+lowestUsedFormatted+'" data-unformatted="'+lowestUsedUnformatted+'" data-rank="'+itemRank+'" data-similar="'+similarproductsstring+'" data-details="'+details+'" data-isbn="'+isbn+'" data-title="'+title+'" data-author="'+author+'" data-category="'+category+'" data-pages="'+pages+'" data-publisher="'+publisher+'" data-pubdate="'+pubdate+'" data-description="'+description+'" data-isbn="'+isbn+'" data-review="'+review+'" data-similar="'+similar+'"   class="wpbooklist-buyback-results-indiv"><img class="wpbooklist-buyback-colorbox" src="'+image+'" /><div id="wpbooklist_saved_title_and_select_div"><p class="wpbooklist_saved_title_link" id="wpbooklist_saved_title_link">'+title+'</p><div style="'+inlinePriceStyle+'" class="wpbooklist-buyback-quote-div"><span class="wpbooklist-buyback-quote-label"></span><span class="wpbooklist-buyback-quote-actual"><img style="height:initial;width:100px;position:relative;top:35px;left:35px;" src="'+wpbooklist_buyback_php_variables.wpbooklistbuybackrootimgiconsurl+'green-checkmark.png"/></span></div><div class="wpbooklist-buyback-checkbox-div"><button style="display:none; opacity:'+buttonOpacity+';" '+disabledButton+' id="wpbooklist-buyback-select-title-button-id-'+0+'" data-triggered="false" data-bookimgsrc="'+image+'" data-bookisbn="'+isbn+'" data-bookvalue="'+finalPriceWithoutSym+'" data-booktitle="'+title+'" data-buttonid="'+0+'" class="wpbooklist-buyback-select-title-button">Sell This Book</button></div></div></div></div>';
	    		}
