				    ...
				    success: function(response) {
				    	...
				    	if(response == 'Success!'){
				    		...
				    		if(buttonClass != 'wpbooklist-buyback-login-button-user-page'){
				    			var newUrl = 'http://localhost:8888/local/buyback/?buybackusername='+email+'&isbn='+isbn+'&book='+book;
				    		} else {
				    			var newUrl = 'http://localhost:8888/local/buyback/';
				    		}
