 ...
 */
class WPBookList_Buyback_Nonmembers_Form {

	public static function output_buyback_nonmembers_form(){
	          	...
	          	<div id="wpbooklist-authorize-amazon-container">
		    		...
		    		<div id="wpbooklist-buyback-div-container">
		    			<div id="wpbooklist-buyback-search-title">
		    				...
		    				.'<button id="wpbooklist-buyback-search-button-nonmembers">Find Book</button>
		    			</div>
